...
class BrigadierCommand(val command: String, private val invocation: LiteralArgumentBuilder<CommandSourceStack>.() -> Unit) {
    
    companion object {
        internal val brigadier = mutableMapOf<BrigadierCommand, LiteralCommandNode<CommandSourceStack>>()
    }
